...
exports.getQuestionsForNotionAndLevel = getQuestionsForNotionAndLevel;
...
function getQuestionsForNotionAndLevel(notion, niveau) {
    return questionsDatabase.filter((q) => q.notion === notion && q.niveau.toLowerCase() === niveau.toLowerCase());
}
