...
exports.notionsOrdreParNiveau = void 0;
exports.choisirAleatoire = choisirAleatoire;
exports.appreciation = appreciation;
exports.notionsOrdreParNiveau = {
...
function choisirAleatoire(arr, n) {
    const copie = [...arr];
    const result = [];
...
function appreciation(note) {
    ...
    if (note >= 12)
        return "Assez bien, mais tu peux faire mieux.";
    if (note >= 10)
        return "Passable, il faut un peu plus d’efforts.";
    if (note >= 7)
        return "Insuffisant, il faut revoir les notions importantes.";
